...
package kr.ac.cnu.computer.foodpedia_app.tracking;
...
import kr.ac.cnu.computer.foodpedia_app.tflite.Classifier.Recognition;
...
//      canvas.drawRoundRect(trackedPos, cornerSize, cornerSize, boxPaint);
            ...
            Log.e("=== trackedPos : ", trackedPos + "");
//            final String labelString =
//                    !TextUtils.isEmpty(recognition.title)
//                            ? String.format("%s %.2f", recognition.title, (100 * recognition.detectionConfidence))
//                            : String.format("%.2f", (100 * recognition.detectionConfidence));
            final String labelString = recognition.title;
            borderedText.drawText(canvas, trackedPos.left, trackedPos.top,
                    labelString,boxPaint);
            Log.e("=== title : ", recognition.title);
